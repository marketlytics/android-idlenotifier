...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sAccountList.setOnItemSelectedListener(new OnItemSelectedListener() {
		    @Override
		...
		toggleButtonService.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonview, boolean isChecked){
        	    ...
        	    editor.putBoolean(KEY_ID, isChecked);
        	    editor.commit();
	...
	private void saveUserAccount() {		
		ParseInstallation.getCurrentInstallation().put(KEY_ID, (String) sAccountList.getSelectedItem());
	...
	private void displayUserProfile() {
		String account = ParseInstallation.getCurrentInstallation().getString(KEY_ID);		
		ArrayAdapter<String> adapter = (ArrayAdapter<String>) sAccountList.getAdapter();
		ArrayAdapter<String> myAdap = adapter;
		int spinnerPosition = myAdap.getPosition(account);
	...
	private void refreshUserProfile() {
		toggleButtonService.setChecked(preferences.getBoolean(KEY_ID, false));
